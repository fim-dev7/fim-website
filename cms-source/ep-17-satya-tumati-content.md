...
- **$4 million** — Raised to reinvent the way the world fights financial crimes
- **Less than a week** — Time to hack together the earliest demo, a small MVP
- **3 things** — What Satya's intuition says YC looks at: is the problem huge, can this team deliver the product, and can they sell it
- **50** — Questions in the YC co-founder matching questionnaire he calls brutal
...
- 04:42 — Validating the problem space — Listen as much as possible in customer calls
- 06:47 — Meeting co-founder Riya through YC — A dating app for founders without the selfies
- 08:58 — Applying to YC with just an idea — No product, no website, not even a name
- 10:46 — When is an MVP enough to sell — Credibility and conviction over perfection
- 14:00 — The first yes — A customer from a completely cold message
- 16:45 — Pricing the first customer — A hybrid approach, stay flexible
- 18:35 — The most valuable lesson — Advice is only true in certain context
- 22:46 — Building from zero — Hard to imagine working on someone else's dream
- 23:43 — Rapid fire — Debug legacy code or sit through an investor workshop
...
>
> — Satya Tumati, on writing code and seeing a robot respond in real time at Cruise (02:57)

> you don't need confidence to go for it because what's the worst that could happen. They would reject you. When you have nothing to lose, why not give this a try.
>
> — Satya Tumati, on applying to YC with just an idea (09:11)

> an MVP isn't about perfection, it's about credibility and conviction. You just need enough for people to believe you can actually deliver what you're promising.
>
> — Satya Tumati, on when an MVP is enough to sell (11:56)

> to our surprise our first customer has actually come from a completely cold message.
>
> — Satya Tumati, on landing the first customer (15:48)

> there's a lot of advice out there about startups and it's true but only in certain context, so people miss that asterisk.
>
...
- **Riya** — Satya's co-founder, met through YC Co-founder Matching; brings product and domain expertise
- **Cruise** — Autonomous vehicles company where Satya worked, connecting his laptop to a car to make real-time changes
- **LinkedIn** — One of the big tech names Satya worked at
- **UCLA** — Where Satya did his masters
- **Y Combinator** — Applied with just an idea; met his co-founder through YC Co-founder Matching
- **Half Moon Bay** — Spot by the ocean in the Bay Area, on a curvy road where Satya pushed code to a moving car
- **Silicon Valley** — The TV show that inspired Satya to come to the US
- **Peter Thiel** — Quoted by Satya: brilliant thinking is rare, but courage is even in shorter supply
...
twitter_share: Satya Tumati used to push code to a moving self-driving car. Now he's raised over $4M to build AI co-workers for fraud and risk teams — and his first customer came from a cold message.

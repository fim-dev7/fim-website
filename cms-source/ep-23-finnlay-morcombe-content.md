...
# Key claims
- **6 million** — Seed round Finnlay raised from Accel, before he'd been in the US more than a few weeks
- **15 million** — In pipeline, with Fortune 100 partners, built by self-taught devs from Melbourne
- **18 funds** — Or less, total, that he spoke to across the whole raise — off a "literal two pager"
- **.1%** — The old SOP documentation product as a share of the new product's capability and value

# Chapters
- 00:00 — Cold open — "agency is so powerful, what's going to happen?"
- 00:40 — The 10,000-subscriber goal
- 00:58 — The raise — 6 million from Accel within weeks of landing in the US
- 01:57 — Advice for Australian founders raising in the US — the two misinterpretations
- 04:39 — Do US investors discount Australian revenue?
- 05:31 — What Fluency actually does — the work ontology
- 09:08 — Where Fluency is heading — world models, not LLMs
- 12:23 — Is agentic AI just RPA on the cloud? — the hot take he no longer holds
- 14:51 — The pivot from SOP creation — and the one-week hard pivot
- 16:27 — Being in your early 20s selling to large enterprises
- 17:44 — Tall poppy syndrome — Melbourne to SF
- 20:05 — The weight of a 6 million raise, and "die trying"
- 21:16 — Loneliness, family, and what building has cost
- 22:46 — What he'd do differently — agency
...
> what we were building perfectly hit a thesis they had internally
>
> — Finnlay Morcombe, on why Accel led the round (02:59)

> agency is so powerful to just like do
>
> — Finnlay Morcombe, on the one thing he'd do differently (22:46)

> we don't allow individual employee monitoring or productivity indexing
>
...
# Mentioned
- **Fluency** — The platform that maps how work actually happens in Fortune 500 organizations
- **Ollie** — Finnlay's co-founder; they went to the US together about 7 months earlier
- **Accel** — Led the 6 million seed round; the round "perfectly hit a thesis they had internally"
- **Facebook** — Investors behind Facebook are referenced in the round's framing
- **Spec Savers** — An Australian customer already on board (alongside "A PBH")
- **Microsoft Copilot** — Used in his CFO example of measuring power users' productivity
- **Princeton** — One of their investors "heads up AI at Princeton" and is focused on world models
- **Porsche** — A mate of his, 22, bought a "half a million dollar Porsche" — his example of tall poppy syndrome

# Background
- **Stage** — Raised 6 million from Accel; most customers are "more larger enterprises"
- **Origin** — Self-taught devs from Melbourne; relocated to San Francisco
- **Traction** — 15 million in pipeline, Fortune 100 partners; revenue split "more predominantly Australian" but the "bigger logos were on the US side"

# Meta
guest_role: Co-founder, Fluency
guest_bio: At 25, Finnlay Morcombe built Fluency — a platform that maps how work actually happens in Fortune 500 organizations — with co-founder Ollie, and raised 6 million from Accel within weeks of landing in the US.
mini_stats: $6M from Accel | $15M in pipeline | 18 funds total | 1-week hard-pivot
tags: AI · Future of Work · Seed
twitter_share: Finnlay Morcombe built Fluency, raised 6 million from Accel off a two-pager before he'd unpacked in SF, and hard pivoted into the product within one week of going to market. Founders In Motion.
